...
//                        saleAmount += 1
//                        
//                        salesList[index] = ProductInformationSQL(productId!, productBarCode!, productName!, productSalePrice!, saleAmount)
...
//                saleAmount += 1
//                salesList.insert(ProductInformationSQL(productId!, productBarCode!, productName!, productSalePrice!, saleAmount), at: 0)
//                salesTableView.reloadData()
//                return
//            } else {
//                print("進入空的購物車")
