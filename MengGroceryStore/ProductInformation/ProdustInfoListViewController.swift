...
class ProdustInfoListViewController: BaseViewController, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate, UISearchResultsUpdating {
    ...
    private func viewInit() {
        ...
        //let sbHeight = mSC.searchBar.intrinsicContentSize.height
        //let navigationHeigh = ( (self.navigationController?.navigationBar.frame.height ?? 0.0) + sbHeight) * deviceScale
